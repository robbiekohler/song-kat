...
export const famousSongs: FamousSong[] = [
  ...
  { id: '4', title: 'She Will Be Loved', artist: 'Maroon 5', year: 2002, genre: 'pop', progressionId: 'i-v-vi-iv', key: 'Bb', mood: ['romantic', 'pop'] },
  { id: '5', title: 'Someone Like You', artist: 'Adele', year: 2011, genre: 'pop', progressionId: 'i-v-vi-iv', key: 'A', mood: ['sad', 'emotional'] },
  { id: '6', title: 'Counting Stars', artist: 'OneRepublic', year: 2013, genre: 'pop', progressionId: 'vi-iv-i-v', key: 'A', mood: ['uplifting', 'energetic'] },
  ...
  { id: '10', title: 'Free Fallin\'', artist: 'Tom Petty', year: 1989, genre: 'rock', progressionId: 'i-bvii-iv-i', key: 'F', mood: ['chill', 'nostalgic'] },
  ...
  { id: '14', title: 'Earth Angel', artist: 'The Penguins', year: 1954, genre: 'doo-wop', progressionId: 'i-vi-iv-v', key: 'A', mood: ['romantic', 'nostalgic'] },
  ...
  // Jazz
  { id: '16', title: 'Autumn Leaves', artist: 'Jazz Standard', year: 1945, genre: 'jazz', progressionId: 'ii-v-i', key: 'G', mood: ['melancholic', 'chill'] },
  ...
  { id: '20', title: 'Riptide', artist: 'Vance Joy', year: 2013, genre: 'indie', progressionId: 'i-iv-vi-v', key: 'G', mood: ['happy', 'chill'] },
  { id: '21', title: 'Take On Me', artist: 'a-ha', year: 1985, genre: 'pop', progressionId: 'i-iv-vi-v', key: 'A', mood: ['energetic', 'uplifting'] },

  // Emotional/Dramatic
  { id: '22', title: 'Africa', artist: 'Toto', year: 1982, genre: 'rock', progressionId: 'vi-iv-i-v', key: 'Db', mood: ['epic', 'emotional'] },
  { id: '23', title: 'Grenade', artist: 'Bruno Mars', year: 2010, genre: 'pop', progressionId: 'vi-iv-i-v', key: 'D', mood: ['dramatic', 'emotional'] },
  { id: '24', title: 'Despacito', artist: 'Luis Fonsi', year: 2017, genre: 'pop', progressionId: 'vi-iv-i-v', key: 'B', mood: ['romantic', 'energetic'] },
  { id: '25', title: 'Numb', artist: 'Linkin Park', year: 2003, genre: 'rock', progressionId: 'vi-iv-i-v', key: 'F#', mood: ['sad', 'dramatic'] },
  ...
  // Minor Key
  { id: '33', title: 'All Along the Watchtower', artist: 'Jimi Hendrix', year: 1968, genre: 'rock', progressionId: 'im-bvi-biii-bvii', key: 'C#', mood: ['dramatic', 'epic'] },
  { id: '34', title: 'Stairway to Heaven', artist: 'Led Zeppelin', year: 1971, genre: 'rock', progressionId: 'im-bvi-biii-bvii', key: 'A', mood: ['epic', 'melancholic'] },
  { id: '35', title: 'Hit the Road Jack', artist: 'Ray Charles', year: 1961, genre: 'soul', progressionId: 'im-iv-v', key: 'A', mood: ['energetic', 'dramatic'] },
  { id: '36', title: 'Sultans of Swing', artist: 'Dire Straits', year: 1978, genre: 'rock', progressionId: 'im-iv-v', key: 'D', mood: ['chill', 'sophisticated'] },

  // Flamenco/Dramatic
  { id: '37', title: 'Smooth', artist: 'Santana', year: 1999, genre: 'rock', progressionId: 'im-bvii-bvi-v', key: 'A', mood: ['romantic', 'dramatic'] },
  { id: '38', title: 'Misirlou', artist: 'Dick Dale', year: 1962, genre: 'surf', progressionId: 'im-bvii-bvi-v', key: 'E', mood: ['dramatic', 'energetic'] },

  // Alternative
  { id: '39', title: 'Mad World', artist: 'Tears for Fears', year: 1982, genre: 'pop', progressionId: 'im-bvi-biii-iv', key: 'F', mood: ['sad', 'melancholic'] },
  { id: '40', title: 'Radioactive', artist: 'Imagine Dragons', year: 2012, genre: 'rock', progressionId: 'im-bvi-biii-iv', key: 'B', mood: ['epic', 'dramatic'] },
  { id: '41', title: 'Boulevard of Broken Dreams', artist: 'Green Day', year: 2004, genre: 'rock', progressionId: 'im-bvi-biii-iv', key: 'F', mood: ['sad', 'melancholic'] },

  // Additional songs
  { id: '42', title: 'Hotel California', artist: 'Eagles', year: 1977, genre: 'rock', progressionId: 'im-bvi-biii-bvii', key: 'B', mood: ['melancholic', 'epic'] },
  { id: '43', title: 'Wonderwall', artist: 'Oasis', year: 1995, genre: 'rock', progressionId: 'i-v-vi-iv', key: 'F#', mood: ['romantic', 'nostalgic'] },
  ...
  { id: '46', title: 'Zombie', artist: 'The Cranberries', year: 1994, genre: 'rock', progressionId: 'vi-iv-i-v', key: 'E', mood: ['dramatic', 'emotional'] },
  { id: '47', title: 'Rolling in the Deep', artist: 'Adele', year: 2010, genre: 'pop', progressionId: 'im-iv-v', key: 'C', mood: ['dramatic', 'powerful'] },
  { id: '48', title: 'Billie Jean', artist: 'Michael Jackson', year: 1982, genre: 'pop', progressionId: 'im-iv-v', key: 'F#', mood: ['dramatic', 'energetic'] },
  { id: '49', title: 'Pumped Up Kicks', artist: 'Foster the People', year: 2010, genre: 'indie', progressionId: 'vi-iv-i-v', key: 'F', mood: ['chill', 'dark'] },
  { id: '50', title: 'Wake Me Up', artist: 'Avicii', year: 2013, genre: 'pop', progressionId: 'vi-iv-i-v', key: 'B', mood: ['uplifting', 'energetic'] },
];
